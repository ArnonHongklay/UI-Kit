...
function directify_fn_listingsingleulli() {
  ...
  var hiddenBox = jQuery(
    '.directify_fn_all_in_one_single_wrap .single_my_select .hidden_box'
  )
  var ulli = jQuery(
    '.directify_fn_all_in_one_single_wrap .single_my_select .hidden_box ul li a'
  )
...
function directify_fn_profile_button() {
  ...
  var btnProfile = jQuery(
    '.directify_fn_single_wrapper .single_profile a.contact'
  )
  var btnCloser = jQuery(
...
function directify_fn_contact_form_contactsend() {
  ...
  jQuery('.directify_fn_btn_contactsend').on('click', function() {
    ...
    if (name === '' || email === '' || message === '') {
      ...
      // Returns successful data submission message when the entered information is stored in database.
      jQuery.post(
        'modal/contactsend.php',
        { xx_name: name, xx_email: email, xx_message: message },
        function(data) {
          jQuery('.contact_form .returnmessage').append(data) //Append returned message to message paragraph
...
function directify_fn_magnific_popup() {
  ...
  jQuery('.directify_fn_gallery').each(function() {
...
function directify_fn_fam_cities_carousel() {
  ...
  var carousel = jQuery(
    '.directify_fn_carousel_famous_cities_wrap .owl-carousel'
  )
  ...
  jQuery(
    '.directify_fn_carousel_famous_cities_wrap .custom_nav a.prev'
  ).on('click', function() {
    carousel.trigger('prev.owl.carousel')
    return false
  })
  ...
  jQuery(
    '.directify_fn_carousel_famous_cities_wrap .custom_nav a.next'
  ).on('click', function() {
    carousel.trigger('next.owl.carousel')
    return false
  })
